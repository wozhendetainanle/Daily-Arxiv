...
每期输出中文摘要并提交到 `daily/YYYY/YYYY-MM-DD.md`，同时更新 `README.md` 的 Archive。摘要最多 50 篇，通常控制在高信号论文范围内。必须包含检索窗口、关键词/分类、总命中数、入选篇数、Top papers 表格、每篇论文 3-5 条中文要点、“今日最值得细读的 5 篇”。
